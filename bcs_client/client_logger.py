...
__doc__ = """
    ...
    * Messages cannot be printed on screen, only in files.
    ...
    Therefore each client has a different log file identified by it's port number.
...
def setup_logging(name):
    ...
    _file_handler = logging.handlers.RotatingFileHandler('logs/%s.log'%name, maxBytes=20*1024,
                                                         backupCount=2,)
